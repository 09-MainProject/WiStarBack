...
class UserAdmin(admin.ModelAdmin):
    ...
    list_display = ('id','email','nickname', 'name','is_active', 'is_staff', 'is_superuser', 'created_at', 'updated_at') # 관리자 목록 페이지에 보여줄 컬럼
    list_filter = ('is_active', 'is_staff', 'is_superuser',)  # 필터 사이드바에 표시할 필드
